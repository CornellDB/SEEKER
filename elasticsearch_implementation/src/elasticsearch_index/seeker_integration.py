...
class ElasticSearchSeeker(DataSeeker):
    """
    Extension of DataSeeker that uses Elasticsearch for indexing and querying.
    """
    def __init__(self, search_query, use_summaries=False):
        """
        Initialize ElasticSearchSeeker.
        ...
        self.indexer = ElasticIndexer(use_summaries=use_summaries)
    
    def index_datasets(self, dataset_models):
        """
        Index the datasets using Elasticsearch.
    ...
    def semantic_search(self, dataset_models, query, search_in_metadata):
        ...
        for result in results:
            ...
            formatted_result = {
                ...
                "top_words": {},  # We could add this from the actual ES result
